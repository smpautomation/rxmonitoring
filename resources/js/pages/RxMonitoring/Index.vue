...
function onChamberPicked() {
  ...
  if (isChamberOpen(num)) {
    router.get('/', { area: props.area.code, chamber: num })
    return
  }
  askConfirm(
    'Open new chamber',
            ...
            <template v-else-if="chamber.current_step === 'before_rx'">
              ...
              <div class="field-row">
                <div class="field-group">
                  ...
                  <input v-model="startForm.start_temperature_c" type="number" min="0" max="300" class="rx-field rx-mono" placeholder="0" />
            ...
            <template v-else-if="chamber.current_step === 'after_rx'">
              ...
              <div class="field-row">
                <div class="field-group">
                  ...
                  <input v-model="stopForm.stop_temperature_c" type="number" min="0" max="300" class="rx-field rx-mono" placeholder="0" />
                </div>
                <div class="field-group">
...
.rx-header__export-link { padding: 0.4rem 0.9rem; min-height: unset; font-size: 0.85rem; text-decoration: none; }
